<div>
    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1" style="margin-top: 18px;padding-right:10px">
        ...
        <ul class="dropdown-menu dropdown-menu-end py-0 {{ $showNotification }}" data-bs-popper="none">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 dropdown-notifications-actions"data-bs-toggle="tooltip" data-bs-placement="top" title="" style="cursor: pointer;"
                            data-bs-original-title="Mark as read" aria-label="Mark as read">
            ...
            <li class="dropdown-menu-footer border-top">
                <a class="dropdown-item d-flex justify-content-center p-3" style="cursor: pointer">
                  Notification System
                </a>
            </li>
        </ul>
